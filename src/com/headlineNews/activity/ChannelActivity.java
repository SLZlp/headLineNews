...
public class ChannelActivity extends BaseActivity implements OnItemClickListener {
	...
	private void initData() {
	    ...
	    otherChannelList = ((ArrayList<Channel>)ChannelManage.getManage(AppApplication.getApp().getSQLHelper()).getOtherChannel());
				...
				new Handler().postDelayed(new Runnable() {
					public void run() {
						try {
							...
							otherAdapter.setRemovePosition(position);
						} catch (Exception localException) {
						}
					}
				}, 50L);
	...
	private void saveChannel() {
		...
		ChannelManage.getManage(AppApplication.getApp().getSQLHelper()).saveOtherChannel(otherAdapter.getChannelList());
	}
