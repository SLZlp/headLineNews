...
import com.headlineNews.tools.DateTools;
import com.headlineNews.tools.Options;
import com.headlineNews.widget.HeadListView;
import com.headlineNews.widget.HeadListView.HeaderAdapter;
...
//			head_title.setText(news.getDate());
	...
	/** 根据属性获取对应的资源ID  */
	public int getAltMarkResID(int mark,int isfavor){
		if(isfavor == 1){
